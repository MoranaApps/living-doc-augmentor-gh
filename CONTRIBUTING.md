...
* **Ensure the bug has not already been reported** by searching our **[GitHub Issues](https://github.com/MoranaApps/living-doc-augmentor-gh/issues)**.
...
* **Check if the feature has already been requested** by searching through our **[GitHub Issues](https://github.com/MoranaApps/living-doc-augmentor-gh/issues)**.
...
All contributions must pass the project quality gates before merging. Run them locally:

```shell
make qa
```

See [DEVELOPER.md](DEVELOPER.md) for details on individual gates (pylint, ruff, mypy, black, radon, pytest, pip-audit).
...
Your contributions are invaluable to us. Thank you for being part of the MoranaApps community and helping us grow and improve!

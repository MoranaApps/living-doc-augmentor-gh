...
- Quality gates
  ...
  - Coverage: pytest --cov=living_doc_augmentor --cov-fail-under=95 tests/
  - Format: black --check .
  - Lint: pylint living_doc_augmentor; ruff check .
  - Types: mypy living_doc_augmentor
  - Complexity: radon cc living_doc_augmentor -a -nb
  - Audit: pip-audit -r requirements.txt
  - Full suite: make qa
- Contract-sensitive outputs
  - code_augmentations.json; annotation violation strings; exit codes (0/1/2).
